      ...
      <div className="aspect-square overflow-hidden bg-zinc-950 relative">
        <img
          ...
          onError={(e) => {
            ...
            target.onerror = null;
            target.src =
              "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' viewBox='0 0 100 100'><rect width='100%' height='100%' fill='%2309090b'/><text x='50%' y='50%' fill='%2352525b' font-family='sans-serif' font-size='10' text-anchor='middle' dominant-baseline='middle'>Image Missing</text></svg>";
          }}
        />
